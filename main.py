...
def inject_brand_css():
    ...
    <style>
      ...
      .notice-white-red {{ background:#fff !important; border:2px solid rgba(255,255,255,1) !important; border-radius:10px; padding:.75rem 1rem; color:#7a0c0c !important; box-shadow:0 6px 18px rgba(7,28,71,.10); }}
